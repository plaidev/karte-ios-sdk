...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "KarteVariables", url: "https://sdk.karte.io/ios/swiftpm/Variables-2.9.0/KarteVariables.xcframework.zip", checksum: "c25ea1e04b933958552b866a88244034515274e8fc08c51d834751c178e425d4"
        ),
        .binaryTarget(
