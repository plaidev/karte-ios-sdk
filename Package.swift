...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "KarteInbox", url: "https://sdk.karte.io/ios/swiftpm/Inbox-0.3.0/KarteInbox.xcframework.zip", checksum: "5ceffd382a602865ab2a0b041126278a4114822598cc8b7d830432760e096bab"
        ),
        .binaryTarget(
